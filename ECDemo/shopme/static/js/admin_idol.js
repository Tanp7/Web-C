...
var del = function(id,name){
	swal({
		...
		jqu.loadJson('/idol/delete.do',{id:id},function(result){
			if(!result.succ){
				swal({
					title:result.stmt,
					icon:'error',
...
var save_seqno = function(){
	...
	swal({
		...
		jqu.loadJson('/idol/setseqno.do',data,function(result){
			if(!result.succ){
				swal({
					title:result.stmt,
					icon:'error',
...
var save_price = function(){
	...
	swal({
		...
		jqu.loadJson('/idol/setprice.do',data,function(result){
			if(!result.succ){
				swal({
					title:result.stmt,
					icon:'error',
